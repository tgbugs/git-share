...
(defvar orgstrap-system-packages nil
...
;; their requirements?
(defvar orgstrap-emacs-packages nil
...
(when orgstrap-system-packages
  (orgstrap---system))

(when (or orgstrap-system-packages orgstrap-emacs-packages)
  (orgstrap---packages))

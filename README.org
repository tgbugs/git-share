...
#+header: :tangle ./org-elisp-setup-hack.el
...
#+begin_src lisp :noweb yes :tangle ./t/args-test :results output :mkdirp yes
<<quicklisp-setup>>
<<package.lisp>>
<<parse-args-cli>>
...
#+begin_src lisp  :noweb yes :tangle ./t/args-test-ecl :results output
<<quicklisp-setup>>
<<package.lisp>>
<<parse-args-cli>>
...
#+begin_src bash :var TEST_HOST="localhost" :results output :tangle ./t/test-curl.sh
